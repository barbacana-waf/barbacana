...
- **Bumped Go toolchain 1.26.4 → 1.26.5** to clear reachable vulnerabilities reported by `govulncheck`:
  - [GO-2026-5856](https://pkg.go.dev/vuln/GO-2026-5856) — Encrypted Client Hello privacy leak in `crypto/tls`
  - [GO-2026-4970](https://pkg.go.dev/vuln/GO-2026-4970) — root escape via symlink plus trailing slash in `os`
