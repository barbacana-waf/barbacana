...
**User guide**: quickstart (Docker Compose), Kubernetes deployment (Helm), onboarding workflow (`mode: detect_only` → `mode: blocking`), per-use-case examples, troubleshooting.
